...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/yaochaoutokyo/bsvutil/coinset)
...
```bash
$ go get -u github.com/yaochaoutokyo/bsvutil/coinset
```
