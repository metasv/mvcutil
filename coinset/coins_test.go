...
import (
	...
	"github.com/yaochaoutokyo/bsvutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    bsvutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() bsvutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value bsvutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = bsvutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = bsvutil.NewTxFromBytes(testSimpleCoinTxBytes)
