...
import (
	...
	"github.com/metasv/mvcutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    mvcutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() mvcutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value mvcutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = mvcutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = mvcutil.NewTxFromBytes(testSimpleCoinTxBytes)
