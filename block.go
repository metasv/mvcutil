...
// Tx returns a wrapped transaction (mvcutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (mvcutil.Tx) for all
...
// instead provides easy access to wrapped versions (mvcutil.Tx) of them.
